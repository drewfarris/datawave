...
public class TermFrequencyKeyValueFactory {
    ...
    protected static void parseColumnVisibility(TermFrequencyKeyValue tfkv, Key key, Authorizations auths, MarkingFunctions markingFunctions) throws MarkingFunctions.Exception {
