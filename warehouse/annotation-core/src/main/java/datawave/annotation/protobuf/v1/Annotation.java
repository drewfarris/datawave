...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override
  public java.util.List<? extends datawave.annotation.protobuf.v1.SegmentOrBuilder> 
   ...
   */
  @java.lang.Override
  public datawave.annotation.protobuf.v1.SegmentOrBuilder getSegmentsOrBuilder(
      int index) {
    return segments_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      metadata__ = MetadataDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(50, metadata__);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getAnnotationType()
        .equals(other.getAnnotationType())) return false;
    if (!getAnalyticSourceHash()
        .equals(other.getAnalyticSourceHash())) return false;
  ...
  public static datawave.annotation.protobuf.v1.Annotation parseFrom(
  ...
  public static datawave.annotation.protobuf.v1.Annotation parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static datawave.annotation.protobuf.v1.Annotation parseFrom(
  ...
  public static datawave.annotation.protobuf.v1.Annotation parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static datawave.annotation.protobuf.v1.Annotation parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(datawave.annotation.protobuf.v1.Annotation other) {
      if (other == datawave.annotation.protobuf.v1.Annotation.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 162: {
              datawave.annotation.protobuf.v1.Segment m =
                  input.readMessage(
                      datawave.annotation.protobuf.v1.Segment.parser(),
                      extensionRegistry);
              if (segmentsBuilder_ == null) {
                ensureSegmentsIsMutable();
                segments_.add(m);
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setAnnotationType(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setAnnotationTypeBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     *
     * <code>string analyticSourceHash = 7;</code>
     * @param value The analyticSourceHash to set.
     * @return This builder for chaining.
     */
    public Builder setAnalyticSourceHash(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     *
     * <code>string analyticSourceHash = 7;</code>
     * @param value The bytes for analyticSourceHash to set.
     * @return This builder for chaining.
     */
    public Builder setAnalyticSourceHashBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        datawave.annotation.protobuf.v1.AnnotationSource, datawave.annotation.protobuf.v1.AnnotationSource.Builder, datawave.annotation.protobuf.v1.AnnotationSourceOrBuilder> sourceBuilder_;
    /**
     * <pre>
     * the source details for this annotation.
     * </pre>
    ...
    public Builder setSource(
        datawave.annotation.protobuf.v1.AnnotationSource.Builder builderForValue) {
      if (sourceBuilder_ == null) {
    ...
    public Builder mergeSource(datawave.annotation.protobuf.v1.AnnotationSource value) {
      if (sourceBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
            source_ != null &&
            source_ != datawave.annotation.protobuf.v1.AnnotationSource.getDefaultInstance()) {
          source_ =
            datawave.annotation.protobuf.v1.AnnotationSource.newBuilder(source_).mergeFrom(value).buildPartial();
        } else {
          source_ = value;
        }
        onChanged();
    ...
    public datawave.annotation.protobuf.v1.AnnotationSourceOrBuilder getSourceOrBuilder() {
      if (sourceBuilder_ != null) {
        ...
        return source_ == null ?
            datawave.annotation.protobuf.v1.AnnotationSource.getDefaultInstance() : source_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        datawave.annotation.protobuf.v1.AnnotationSource, datawave.annotation.protobuf.v1.AnnotationSource.Builder, datawave.annotation.protobuf.v1.AnnotationSourceOrBuilder> 
        getSourceFieldBuilder() {
      if (sourceBuilder_ == null) {
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        datawave.annotation.protobuf.v1.Segment, datawave.annotation.protobuf.v1.Segment.Builder, datawave.annotation.protobuf.v1.SegmentOrBuilder> segmentsBuilder_;
    ...
    public Builder setSegments(
        int index, datawave.annotation.protobuf.v1.Segment value) {
      if (segmentsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setSegments(
        int index, datawave.annotation.protobuf.v1.Segment.Builder builderForValue) {
      if (segmentsBuilder_ == null) {
        ensureSegmentsIsMutable();
     ...
     */
    public Builder addSegments(
        datawave.annotation.protobuf.v1.Segment.Builder builderForValue) {
      if (segmentsBuilder_ == null) {
        ensureSegmentsIsMutable();
    ...
    public Builder addAllSegments(
        java.lang.Iterable<? extends datawave.annotation.protobuf.v1.Segment> values) {
      if (segmentsBuilder_ == null) {
        ensureSegmentsIsMutable();
     ...
     * <code>repeated .datawave.annotation.protobuf.v1.Segment segments = 20;</code>
     */
    public datawave.annotation.protobuf.v1.Segment.Builder getSegmentsBuilder(
        int index) {
    ...
    public datawave.annotation.protobuf.v1.Segment.Builder addSegmentsBuilder() {
      return getSegmentsFieldBuilder().addBuilder(
          datawave.annotation.protobuf.v1.Segment.getDefaultInstance());
    }
    /**
     * <pre>
     * segment data
    ...
    public datawave.annotation.protobuf.v1.Segment.Builder addSegmentsBuilder(
        int index) {
      return getSegmentsFieldBuilder().addBuilder(
          index, datawave.annotation.protobuf.v1.Segment.getDefaultInstance());
    }
    /**
     * <pre>
     * segment data
     ...
     * <code>repeated .datawave.annotation.protobuf.v1.Segment segments = 20;</code>
     */
    public java.util.List<datawave.annotation.protobuf.v1.Segment.Builder> 
         getSegmentsBuilderList() {
      return getSegmentsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        datawave.annotation.protobuf.v1.Segment, datawave.annotation.protobuf.v1.Segment.Builder, datawave.annotation.protobuf.v1.SegmentOrBuilder> 
        getSegmentsFieldBuilder() {
      if (segmentsBuilder_ == null) {
