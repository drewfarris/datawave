...
public class Annotation {
    ...
    /**
     *
     * @param shard the shard of the annotated document
     * @param dataType the data type of the annotated document
     * @param uid the uid of the annotated document
     * @param annotationType the type of the annotation
     * @param annotationId the uid of the annotation - must be unique per document
     * @param metadata optional metadata associated with the annotation
     * @param segments the segments of the document this annotation is associated with
     */
    protected Annotation(String shard, String dataType, UID uid, String annotationType, UID annotationId, Map<String, String> metadata, List<Segment> segments) {
        this.shard = shard;
    ...
    public static class Builder {
        ...
        private static final Validator<Annotation> annotationValidator = Validator.<Annotation>create()
                .addCheck(hasValidShard, "shard must be valid")
        ...
        public Builder setAnnotationId(UID annotationId) {
            this.annotationId = annotationId;
            return this;
        }
